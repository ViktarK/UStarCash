This app utilizes a WebView component to interface with Ustarcashe's lender database. It allows the process of reaching out to lenders much faster, more convenient and way to appealing.
